...
public class AggregatorController {
    ...
    public ResponseEntity<List<OrderInfo>> getOffers(@RequestBody Order order) {
        return ResponseEntity.status(HttpStatus.OK)
                .body(aggregatorService.getOffers(order));
    }

    @PostMapping(value = "/take-offer")
    public ResponseEntity<OrderInfo> takeOffer(@RequestBody AggregatorOffer aggregatorOffer) {
    ...
    public ResponseEntity<OrderInfo> takeOf (@RequestBody AggregatorOffer aggregatorOffer) {
